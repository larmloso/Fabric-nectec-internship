    ...
    - 
        ...
        Policies:
            ...
            Writers:
                ...
                Type: Signature" >addOrg4MSP/configtx.yaml
...
function configChannel() {
    ...
    peer channel update -f channel-artifacts/org4_update_in_envelope.pb -c mychannel -o ${DOMAIN1}:8050 \
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer0.${DOMAIN3}/tls/ca.crt
    ...
    jq '.channel_group.groups.Application.groups.Org4MSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.'${DOMAIN3}'","port": '${PORT3}'}]},"version": "0"}}' config.json >modified_anchor_config.json
