...
endpoint1=http://larmdev.ml:3000
endpoint2=http://larmdev.ga:3000

./envAPI.sh ${portApi} ${ChannelName} ${chaincodeName} Org1MSP 1 ${endpoint1}
scp -r ./chaincode root@${domain1}:

./envAPI.sh ${portApi} ${ChannelName} ${chaincodeName} Org2MSP 2 ${endpoint2}
