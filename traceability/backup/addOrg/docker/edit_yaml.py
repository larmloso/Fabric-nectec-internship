...
def peer():
    ...
    with open(path) as f:
        y=yaml.safe_load(f)
        y['volumes'][f'{sys.argv[3]}'] = y['volumes']['peer0.org3.com']
        del y['volumes']['peer0.org3.com']

        y['services'][f'{sys.argv[3]}'] = y['services']['peer0.org3.com']
        del y['services']['peer0.org3.com']
        ...
        y['services'][f'{sys.argv[3]}']['volumes'][1] = f'../{sys.argv[2]}/peerOrganizations/org3.example.com/peers/{sys.argv[3]}/msp:/etc/hyperledger/fabric/msp'
        y['services'][f'{sys.argv[3]}']['volumes'][2] = f'../{sys.argv[2]}/peerOrganizations/org3.example.com/peers/{sys.argv[3]}/tls:/etc/hyperledger/fabric/tls'
...
def couch():
    ...
    with open(path) as f:
        y=yaml.safe_load(f)
        y['services'][f'peer0.{sys.argv[2]}'] = y['services']['peer0.org3.com']
        del y['services']['peer0.org3.com']
...
def configtx():
    ...
    with open(path) as f:
        ...
        y['Organizations'][0]['MSPDir'] = f'../{sys.argv[2]}/peerOrganizations/org3.example.com/msp'
