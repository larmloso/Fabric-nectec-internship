...
function updateConfigChannel() {
    ...
    if [ -z "$DOMAIN1" ]; then
        ...
        scp -r root@$DOMAIN3:/root/organizations/peerOrganizations/org3.example.com ${PWD}/../Downloads
        ...
        scp -r ../Downloads/org3.example.com root@$DOMAIN1:/root/organizations/peerOrganizations/org3.example.com
