...
app.get('/ReadAsset/:id', async (req: Request, res: Response) => {
...
app.get('/GetAllAssets', async (req: Request, res: Response) => {
    try {
        let item;
        try {
            const ccp = CCP;
...
app.get('/filters/:filter/:method/:pageSize/:bookmark', async (req: Request, res: Response) => {
...
app.post("/CreateAsset", async (req: Request, res: Response) => {
    try {
        const item = req.body;
...
app.post("/CreateProcess", async (req: Request, res: Response) => {
    try {
        const item = req.body;
        let amount = 0;
        const datetime = item.datetime;
...
app.post("/TransferAsset", async (req: Request, res: Response) => {
    try {
        const item = req.body;
